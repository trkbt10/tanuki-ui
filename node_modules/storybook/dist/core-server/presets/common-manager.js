...
import { global as kC } from "@storybook/global";
import { addons as OC } from "storybook/manager-api";
...
import gA from "react";
import { withReset as Ws } from "storybook/internal/components";
import { styled as Xr } from "storybook/theming";
var te = /* @__PURE__ */ a((e) => `& :where(${e}:not(.sb-anchor, .sb-unstyled, .sb-unstyled ${e}))`, "toGlobalSelector"), An = 600, xA = Xr.
h1(Ws, ({ theme: e }) => ({
...
import FA, { useEffect as jA, useRef as RA, useState as HA } from "react";
import { ErrorFormatter as zA, Loader as $A, getStoryHref as UA } from "storybook/internal/components";
import { styled as fm } from "storybook/theming";

// ../addons/docs/src/blocks/components/IFrame.tsx
import OA, { Component as IA } from "react";
var { window: PA } = globalThis;
...
// ../addons/docs/src/blocks/components/Story.tsx
var { PREVIEW_URL: JA } = globalThis;
var KA = fm.strong(({ theme: e }) => ({
...
import Vk from "react";
import { ResetWrapper as $k } from "storybook/internal/components";
import { styled as Te } from "storybook/theming";
var Gk = Te.div(({ theme: e }) => ({
  fontWeight: e.typography.weight.bold,
  color: e.color.defaultText
})), Jk = Te.div(({ theme: e }) => ({
...
import { ResetWrapper as d2 } from "storybook/internal/components";
import { styled as Qr } from "storybook/theming";
var g2 = Qr.div(({ theme: e }) => ({
  fontFamily: e.typography.fonts.base,
  fontSize: e.typography.size.s1,
  color: e.color.defaultText,
  marginLeft: 10,
...
import Y2, { useEffect as X2, useId as Z2 } from "react";
import { NAVIGATE_URL as eO } from "storybook/internal/core-events";
...
import { AddonPanel as TS } from "storybook/internal/components";
import { Consumer as AS, addons as Id, types as kS } from "storybook/manager-api";

// src/component-testing/components/Panel.tsx
import Td, { Fragment as pS, memo as uS, useEffect as Ei, useMemo as Ad, useRef as Si, useState as Ci } from "react";
import {
  FORCE_REMOUNT as dS,
  PLAY_FUNCTION_THREW_EXCEPTION as fS,
  STORY_RENDER_PHASE_CHANGED as mS,
  STORY_THREW_EXCEPTION as gS,
  UNHANDLED_ERRORS_WHILE_PLAYING as hS
} from "storybook/internal/core-events";
import { global as wi } from "@storybook/global";
import {
  experimental_useStatusStore as bS,
  useAddonState as yS,
  useChannel as xS,
  useParameter as vS
} from "storybook/manager-api";
...
var IN = `${gt}/result`, PN = `${gt}/request`, LN = `${gt}/running`, NN = `${gt}/error`, _N = `${gt}/manual`, DN = `${gt}/select`, c1 = "wri\
ting-tests/accessibility-testing", BN = `${c1}#why-are-my-tests-failing-in-different-environments`;

// ../addons/vitest/src/constants.ts
var Up = "storybook/test", FN = `${Up}/test-provider`, qp = "STORYBOOK_ADDON_TEST_CHANNEL";
var p1 = "writing-tests/integrations/vitest-addon", jN = `${p1}#what-happens-if-vitest-itself-has-an-error`;
var u1 = {
  id: Up,
  initialState: {
    config: {
...
var YE = Ve.div(({ theme: e }) => ({
  ...
  marginBottom: 1,
  lineHeight: "12px"
}), oS = Ve(Nr)(({ theme: e, animating: t, disabled: r }) => ({
  opacity: r ? 0.5 : 1,
  svg: {
  ...
  return /* @__PURE__ */ q.createElement(YE, null, /* @__PURE__ */ q.createElement(RE, null, /* @__PURE__ */ q.createElement(XE, { "aria-lab\
el": "Component tests toolbar" }, /* @__PURE__ */ q.createElement(hd, null, /* @__PURE__ */ q.createElement(gd, { status: r }), /* @__PURE__ */ q.
  createElement(rS, { onClick: n, disabled: !n }, i), /* @__PURE__ */ q.createElement(QE, null), /* @__PURE__ */ q.createElement(Pr, { trigger: "\
hover", hasChrome: !1, tooltip: /* @__PURE__ */ q.createElement(Lr, { note: "Go to start" }) }, /* @__PURE__ */ q.createElement(
    tS,
    {
...
d" }) }, /* @__PURE__ */ q.createElement(
  ...
  /* @__PURE__ */ q.createElement(oS, { "aria-label": "Rerun", onClick: e.rerun }, /* @__PURE__ */ q.createElement(KE, null)))), o && /* @__PURE__ */ q.
  createElement(hd, null, /* @__PURE__ */ q.createElement(eS, null, o)))));
}, "Subnav");

// src/component-testing/components/TestDiscrepancyMessage.tsx
import yd from "react";
import { Link as nS } from "storybook/internal/components";
import { useStorybookApi as aS } from "storybook/manager-api";
import { styled as iS } from "storybook/theming";
var sS = iS.div(({ theme: { color: e, typography: t, background: r } }) => ({
  textAlign: "start",
  padding: "11px 15px",
  fontSize: `${t.size.s2 - 1}px`,
  fontWeight: t.weight.regular,
  ...
  return /* @__PURE__ */ yd.createElement(sS, null, "This interaction test passed in ", o, ", but the tests failed in ", n, ".", " ", /* @__PURE__ */ yd.
  createElement(nS, { href: r, target: "_blank", withArrow: !0 }, "Learn what could cause this"));
}, "TestDiscrepancyMessage");

// src/component-testing/components/InteractionsPanel.tsx
var lS = er.div(({ theme: e }) => ({
  height: "100%",
  background: e.background.content
})), vd = er.div(({ theme: e }) => ({
  borderBottom: `1px solid ${e.appBorderColor}`,
  ...
  /* @__PURE__ */ a(function({
    ...
    cS, null, "Found ", u.length, " unhandled error", u.length > 1 ? "s" : "", " ", "while running the play function. This might cause false\
...
var en = {
  ...
  status: e,
  ancestors: []
}), "getInternalRenderLogItem"), kd = uS(
  /* @__PURE__ */ a(function({ refId: t, storyId: r, storyUrl: o }) {
    let { statusValue: n, testRunId: i } = bS((B) => {
    ...
    let z = Ad(
      ...
      [_, r]
    ), W = vS("fileName", ""), [ee] = W.toString().split("/").slice(-1), ce = /* @__PURE__ */ a(() => c?.scrollIntoView({ behavior: "smooth",
    ...
    return Ei(() => {
      if (ae && n && n !== "status-value:pending" && n !== ES[ae]) {
        let R = setTimeout(
          () => m((T) => (T || _(qp, {
        ...
        m(!1);
    }, [_, ae, n, r, i]), /* @__PURE__ */ Td.createElement(pS, { key: "component-tests" }, /* @__PURE__ */ Td.createElement(
      wd,
      {
        storyUrl: o,
        hasResultMismatch: p,
...
import { Badge as SS } from "storybook/internal/components";
import { useAddonState as CS, useStorybookApi as wS } from "storybook/manager-api";
function Od() {
  let t = wS().getSelectedPanel(), [r = {}] = CS(Nt), { isErrored: o, hasException: n, interactionsCount: i } = r;
  return /* @__PURE__ */ on.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ on.createElement(
  "span", null, "Interactions"), i && !o && !n ? /* @__PURE__ */ on.createElement(SS, { compact: !0, status: t === Zt ? "active" : "neutral" },
...
var Pd = Id.register(Nt, () => {
  if (globalThis?.FEATURES?.interactions) {
    ...
    Id.add(Zt, {
      ...
      render: /* @__PURE__ */ a(({ active: t }) => /* @__PURE__ */ nn.createElement(TS, { active: !!t }, /* @__PURE__ */ nn.createElement(AS,
...
import HS from "react";
import { addons as Bd, types as VS } from "storybook/manager-api";

// src/backgrounds/components/Tool.tsx
import Je, { Fragment as OS, memo as _d, useCallback as IS, useState as PS } from "react";
import { IconButton as Nd, TooltipLinkList as LS, WithTooltip as NS } from "storybook/internal/components";
import { CircleIcon as _S, GridIcon as DS, PhotoIcon as BS, RefreshIcon as MS } from "@storybook/icons";
import { useGlobals as FS, useParameter as jS } from "storybook/manager-api";
...
var Dd = _d(/* @__PURE__ */ a(function() {
  let t = jS(_r), [r, o, n] = FS(), [i, s] = PS(!1), { options: l = Ld, disable: c = !0 } = t || {};
  if (c)
    return null;
...
}, "BackgroundSelector")), RS = _d(/* @__PURE__ */ a(function(t) {
  let {
    item: r,
    length: o,
    updateGlobals: n,
  ...
  return /* @__PURE__ */ Je.createElement(OS, null, /* @__PURE__ */ Je.createElement(
    Nd,
    {
      key: "grid",
      active: u,
    ...
    /* @__PURE__ */ Je.createElement(DS, null)
        ...
        LS,
        {
          links: [
            ...r ? [
              {
                ...
                icon: /* @__PURE__ */ Je.createElement(MS, null),
                onClick: /* @__PURE__ */ a(() => {
                  g(void 0), p();
                }, "onClick")
              }
            ...
            ...Object.entries(s).map(([m, f]) => ({
              id: m,
              title: f.name,
              icon: /* @__PURE__ */ Je.createElement(_S, { color: f?.value || "grey" }),
              active: m === l,
              onClick: /* @__PURE__ */ a(() => {
                g({ value: m, grid: u }), p();
              }, "onClick")
...
var Md = Bd.register(an, () => {
  globalThis?.FEATURES?.backgrounds && Bd.add(an, {
    ...
    render: /* @__PURE__ */ a(() => /* @__PURE__ */ HS.createElement(Dd, null), "render")
  });
});

// src/measure/manager.tsx
import JS from "react";
import { addons as Rd, types as KS } from "storybook/manager-api";

// src/measure/Tool.tsx
import Fd, { useCallback as zS, useEffect as $S } from "react";
import { IconButton as US } from "storybook/internal/components";
import { RulerIcon as qS } from "@storybook/icons";
import { useGlobals as WS, useStorybookApi as GS } from "storybook/manager-api";
...
// src/measure/Tool.tsx
var jd = /* @__PURE__ */ a(() => {
  let [e, t] = WS(), { measureEnabled: r } = e || {}, o = GS(), n = zS(
    () => t({
      measureEnabled: !r
    }),
    [t, r]
  ...
  return $S(() => {
    ...
    /* @__PURE__ */ Fd.createElement(qS, null)
  );
}, "Tool");
...
var Hd = Rd.register(Et, () => {
  globalThis?.FEATURES?.measure && Rd.add(sn, {
    ...
    render: /* @__PURE__ */ a(() => /* @__PURE__ */ JS.createElement(jd, null), "render")
  });
});

// src/outline/manager.tsx
import oC from "react";
import { addons as $d, types as nC } from "storybook/manager-api";

// src/outline/OutlineSelector.tsx
import Vd, { memo as YS, useCallback as XS, useEffect as ZS } from "react";
import { IconButton as QS } from "storybook/internal/components";
import { OutlineIcon as eC } from "@storybook/icons";
...
// src/outline/OutlineSelector.tsx
var zd = YS(/* @__PURE__ */ a(function() {
  let [t, r] = tC(), o = rC(), n = [!0, "true"].includes(t[Ai]), i = XS(
    () => r({
      [Ai]: !n
    }),
    [n]
...
import { addons as ef, types as AC } from "storybook/manager-api";

// src/viewport/components/Tool.tsx
import Se, { Fragment as dC, useCallback as fC, useEffect as mC, useState as gC } from "react";
import { IconButton as hC, TooltipLinkList as bC, WithTooltip as yC } from "storybook/internal/components";
import { GrowIcon as xC, RefreshIcon as vC, TransferIcon as EC } from "@storybook/icons";
import { useGlobals as SC, useParameter as CC } from "storybook/manager-api";
import { Global as wC } from "storybook/theming";

// src/viewport/constants.ts
var St = "storybook/viewport", Br = "viewport", y3 = `${St}/panel`, qd = `${St}/tool`;
...
var Gd = /* @__PURE__ */ a((e, t) => e.indexOf(t), "getCurrentViewportIndex"), aC = /* @__PURE__ */ a((e, t) => {
  let r = Gd(e, t);
  return r === e.length - 1 ? e[0] : e[r + 1];
}, "getNextViewport"), iC = /* @__PURE__ */ a((e, t) => {
  let r = Gd(e, t);
...
import ln, { Fragment as sC } from "react";
import { IconButton as lC } from "storybook/internal/components";
import { BrowserIcon as cC, MobileIcon as pC, TabletIcon as uC } from "@storybook/icons";
...
var Kd = cn.div({
  ...
  desktop: /* @__PURE__ */ ln.createElement(cC, null),
  mobile: /* @__PURE__ */ ln.createElement(pC, null),
  tablet: /* @__PURE__ */ ln.createElement(uC, null),
  other: /* @__PURE__ */ ln.createElement(sC, null)
};
...
var Qd = /* @__PURE__ */ a(({ api: e }) => {
...
}, "ViewportTool"), TC = Se.memo(/* @__PURE__ */ a(function(t) {
  let {
    item: r,
    viewportMap: o,
    viewportName: n,
  ...
  return /* @__PURE__ */ Se.createElement(dC, null, /* @__PURE__ */ Se.createElement(
    yC,
    {
      placement: "bottom",
            ...
            ...length > 0 && r !== tr ? [
              {
                ...
                icon: /* @__PURE__ */ Se.createElement(vC, null),
                onClick: /* @__PURE__ */ a(() => {
                  p(void 0), m();
                }, "onClick")
              }
    ...
    /* @__PURE__ */ Se.createElement(
      ...
      /* @__PURE__ */ Se.createElement(xC, null),
  ...
  "")), c ? "/" : /* @__PURE__ */ Se.createElement(
    ...
    /* @__PURE__ */ Se.createElement(EC, null)
...
// src/core-server/presets/common-manager.ts
var IC = "tag-filters", PC = "static-filter", LC = OC.register(IC, (e) => {
  let t = Object.entries(kC.TAGS_OPTIONS ?? {}).reduce(
    (r, o) => {
      let [n, i] = o;
