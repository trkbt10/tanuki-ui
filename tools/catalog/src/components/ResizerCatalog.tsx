  ...
  return (
    <Article className={styles.page}>
      <Header className={styles.header}>
        <H1>Resizer Catalog</H1>
        <P className={styles.lead}>
          Resizer はエッジやコーナーのドラッグで領域サイズを調整する低レベルコンポーネントです。カードの拡縮や
          レイアウト分割など、実用的なシナリオを確認しましょう。
        </P>
        <Small className={styles.helperText}>onResize から取得できる delta を元に幅・高さを自由に更新できます。</Small>
      </Header>
      ...
      <Main className={styles.main}>
        ...
        <Section className={styles.section}>
          ...
          <div className={styles.exampleCard}>
            <H3>固定ヘッダー付きのワークスペース</H3>
            <P>サイドバー幅をドラッグで調整し、残り領域にプレビューを表示する典型的な UI です。</P>
